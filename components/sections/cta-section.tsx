...
import { MobileCtaSection } from "@/components/mobile/mobile-cta-section"
...
export function CtaSection() {
  ...
  if (isMobile) {
    return <MobileCtaSection />
  }

  return (
    <section className="py-16 md:py-24 bg-gradient-to-r from-pink-700 to-pink-900 relative overflow-hidden" ref={ref}>
      ...
      <div className="container relative">
        <div className={`max-w-3xl mx-auto text-center reveal ${isVisible ? "active" : ""}`}>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <CtaButton variant="white" text="Garantir Essa Oferta" />
            <Button
              size="lg"
              variant="outline"
              className="border-white text-white hover:bg-white/10 hover-lift group"
